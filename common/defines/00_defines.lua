...
NDiplomacy = {
	...
	MAX_FEAR_VALUE = 150,							-- Max fear value cap.
	MIN_FEAR_VALUE = -150,							-- Min fear  value cap.
	...
	MAX_OPINION_VALUE = 150,						-- Max opinion value cap.
	...
	WARGOAL_VERSUS_MAJOR_AT_WAR_REDUCTION = -0.5, 	-- reduction of pp cost for wargoal vs major at war.
	...
	MIN_WARGOAL_JUSTIFY_COST = 5.0,					-- It always takes atleast 10 days to justify a wargoal
	WARGOAL_PER_JUSTIFY_AND_WAR_COST_FACTOR = 0.0,	-- Cost factor per nation at war with or justifying against
	...
	TENSION_SIZE_FACTOR = 0.3,						-- All action tension values are multiplied by this value
...
NCountry = {
	...
	LOCAL_MANPOWER_ACCESSIBLE_NON_CORE_FACTOR = 0.25,  -- accessible recruitable factor base
	...
	DEFAULT_NATIONAL_UNITY = 0.75,					-- Default national unity if not scripted otherwise.
...
NMilitary = {
	...
	PLAN_NEIGHBORING_ENEMY_PROVINCE_FACTOR = 1.0,	-- When calculating the importance of provinces, it takes number of enemy provinces into account, factored by this
...
NAI = {
	GARRISON_FRACTION = 0.03, 					-- How large part of a front should always be holding the line rather than advancing at the enemy
	
	DIPLOMATIC_ACTION_GOOD_BAD_RATIO_THRESHOLD = 1,
	BASE_RELUCTANCE = 25, 						-- Base reluctance applied to all diplomatic offers
	DIPLOMATIC_ACTION_RANDOM_FACTOR = 0.75, 		-- How much of the AI diplomatic action scoring is randomly determined (1.0 = half random, 2.0 = 2/3rd random, etc)
	...
	DIPLOMACY_CREATE_FACTION_FACTOR = 0.9,		-- Factor for AI desire to create a new faction. Val < 1.0 makes it less likely to create than to join.
	...
	JOIN_FACTION_BOTH_LOSING = -250,			-- Desire to be in a faction when both we and htey are in losing wars
	...
	GENERATE_WARGOAL_THREAT_BASELINE = 0.0,	-- The baseline for what the AI considers the world is getting dangerous and we want to generate wargoals	
	...
	EASY_TARGET_FRONT_IMPORTANCE = 7.0,			-- How much extra focus the AI should put on who it considers to be the easiest target.
	...
	VP_LEVEL_IMPORTANCE_HIGH = 10,				-- Victory points with values higher than or equal to this are considered to be of high importance.
	...
	ENTRENCHMENT_WEIGHT = 1.8,					-- AI should favour units with less entrenchment when assigning units around.
	...
	STR_UNIT_WEAK = 0.15,						-- Strength (equipment) % for unit to be considered weak
	...
	DIPLOMACY_AT_WAR_WITH_ALLY_RELUCTANCE = -200,

	CALL_ALLY_WT_LIMIT = 0.4,                           -- fascists are hesitant to call allies if tension is lower than this
	CALL_ALLY_FASCIST_DESIRE_WT = -50,                  -- less desire if we are below the tension limit
